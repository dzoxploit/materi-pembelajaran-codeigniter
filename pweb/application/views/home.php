...
<div class="pricing-header px-3 py-1 pt-md-3 pb-md-4 mx-auto text-center">
  ...
  <?php endif ?>	
  <?php if($this->session->flashdata('pesan') == "Diupdate"): ?>
							<div class="alert alert-success" role="alert">
     ...
     <?php foreach($nilai as $data):?>
      <tr
        ...
        <td class="align-middle text-center">
          <a href="<?=base_url('pweb/update/'.$data['id_nilai']);?>" class="align-middle btn btn-success">Edit</a>
          <a href="<?=base_url('pweb/delete/'.$data['id_nilai']);?>" class="align-middle btn btn-danger">Hapus</a>
        </td>
      </tr>
      <?php endforeach ?>
